...
with cte as (
select  --distinct c.*, lm.* ,sm.*,m.*,e.*
c.founder,c.company_code,lm.Lead_Manager_code,sm.senior_manager_code,m.manager_code,e.employee_code
from company c 
...
where 1=1 -- and c.company_code='C1'
)
select 
